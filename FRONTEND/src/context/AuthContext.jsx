...
export function AuthProvider({ children }) {
  ...
  // Structure : { id, name, email, role: 'citoyen'|'autorite', commune, avatar }
  ...
  const login = (userData) => {
    ...
    // Persiste le token d'authentification (sera utilisé par Axios)
    localStorage.setItem('eco-token', userData.token || 'mock-token-kinshasa-2024')
  }
   ...
   * @param {string} role - Le rôle à vérifier ('citoyen' ou 'autorite')
   * @returns {boolean}
   */
